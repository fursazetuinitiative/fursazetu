...
namespace HesterCoreVendor\enshrined\svgSanitize\ElementReference;

use HesterCoreVendor\enshrined\svgSanitize\data\XPath;
use HesterCoreVendor\enshrined\svgSanitize\Exceptions\NestingException;
use HesterCoreVendor\enshrined\svgSanitize\Helper;
class Resolver {
