...
namespace Hester_Core\Elementor\Modules\Tabs\Widgets;
...
class Tabs extends Base_Widget {
	...
	public function get_title() {
		return __( 'Tabs', 'hester-core' );
	}

	public function get_icon() {

		return 'hester-icon eicon-tabs';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'tabs',
			array(
				'label'       => __( 'Items', 'hester-core' ),
				'type'        => Controls_Manager::REPEATER,
				'default'     => array(
					array(
						'tab_title'   => __( 'Tab #1', 'hester-core' ),
						'tab_content' => __( 'I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'hester-core' ),
					),
					array(
						'tab_title'   => __( 'Tab #2', 'hester-core' ),
						'tab_content' => __( 'I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'hester-core' ),
					),
					array(
						'tab_title'   => __( 'Tab #3', 'hester-core' ),
						'tab_content' => __( 'I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'hester-core' ),
					),
				),
				'fields'      => array(
					array(
						'name'        => 'tab_title',
						'label'       => __( 'Title & Content', 'hester-core' ),
						'type'        => Controls_Manager::TEXT,
						'default'     => __( 'Tab Title', 'hester-core' ),
						'label_block' => true,
						'dynamic'     => array( 'active' => true ),
					),
					array(
						'name'    => 'source',
						'label'   => __( 'Select Source', 'hester-core' ),
					...
					array(
						...
						'default'    => __( 'I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'hester-core' ),
						'show_label' => false,
						'condition'  => array(
							'source' => 'custom',
						),
		...
		$this->start_controls_section(
			'section_additional',
			array(
				'label' => __( 'Additional Options', 'hester-core' ),
			)
		);
		...
		$this->add_control(
			'active_item',
			array(
				'label' => __( 'Active Item No', 'hester-core' ),
		...
		$this->add_responsive_control(
			'tab_spacing',
			array(
				'label'     => __( 'Tab Spacing', 'hester-core' ),
				...
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs-wrap' => 'margin-left: -{{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs-wrap .hester-tab-title' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs-left .hester-tabs-wrap .hester-tab-title, {{WRAPPER}} .hester-tabs-right .hester-tabs-wrap .hester-tab-title' => 'margin-top: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .hester-tabs .hester-tab-title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .hester-tabs .hester-tab-title.hester-active',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title.hester-active' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title.hester-active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Tab Content', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .hester-tabs .hester-tab-content',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .hester-tabs .hester-tabs-content-wrap',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-content' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			'content_spacing',
			array(
				'label'     => __( 'Content Spacing', 'hester-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min' => 0,
				...
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs.hester-tabs-top .hester-tab-content' => 'margin-top: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs.hester-tabs-bottom .hester-tab-content' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs.hester-tabs-left .hester-tab-content' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs.hester-tabs-right .hester-tab-content' => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-content, {{WRAPPER}} .hester-tabs .hester-tab-mobile-title' => 'border-width: {{SIZE}}{{UNIT}}; border-top: 0;',
					'{{WRAPPER}} .hester-tabs .hester-tabs-content-wrap' => 'border-top-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Border Style', 'hester-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'solid',
				'options'   => array(
					'none'   => __( 'None', 'hester-core' ),
					'solid'  => __( 'Solid', 'hester-core' ),
					'double' => __( 'Double', 'hester-core' ),
					'dotted' => __( 'Dotted', 'hester-core' ),
					'dashed' => __( 'Dashed', 'hester-core' ),
					'groove' => __( 'Groove', 'hester-core' ),
				),
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-content, {{WRAPPER}} .hester-tabs .hester-tab-mobile-title' => 'border-style: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-content, {{WRAPPER}} .hester-tabs .hester-tab-mobile-title, {{WRAPPER}} .hester-tabs .hester-tabs-content-wrap' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .hester-tabs .hester-tabs-content-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'left'  => array(
						'title' => __( 'Start', 'hester-core' ),
						'icon'  => 'eicon-h-align-left',
					),
					'right' => array(
						'title' => __( 'End', 'hester-core' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title i' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title.hester-active i' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .hester-tabs .hester-tab-title .hester-icon-align-left' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .hester-tabs .hester-tab-title .hester-icon-align-right' => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->start_controls_section(
			'section_item_style',
			array(
				'label' => __( 'Product Item', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			'section_image_style',
			array(
				'label' => __( 'Product Image', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Product Content', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Product Button', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			'section_badge_style',
			array(
				'label' => __( 'Product Badge', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function render() {
		...
		if ( ! empty( $settings['active_item'] ) ) {
			...
			$this->add_render_attribute( 'wrap', 'class', 'hester-has-active-item' );
			$this->add_render_attribute( 'wrap', 'data-settings', wp_json_encode( $data ) );
		}

		$this->add_render_attribute( 'tabs-wrap', 'class', 'hester-tabs-wrap' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrap' ); ?>>
			...
			<?php if ( 'bottom' != $layout ) { ?>
				<div <?php echo $this->get_render_attribute_string( 'tabs-wrap' ); ?>>
					...
					foreach ( $settings['tabs'] as $index => $item ) :
						$tab_count     = $index + 1;
						$active_item   = ( $tab_count === $settings['active_item'] ) ? ' hester-active' : '';
						$tab_title_key = $this->get_repeater_setting_key( 'tab_title', 'tabs', $index );

						$this->add_render_attribute(
							$tab_title_key,
							array(
								'id'            => 'hester-tab-title-' . $id_int . $tab_count,
								'class'         => array( 'hester-tab-title', $active_item ),
								'data-tab'      => $tab_count,
								'tabindex'      => $id_int . $tab_count,
								'role'          => 'tab',
								'aria-controls' => 'hester-tab-content-' . $id_int . $tab_count,
							)
						);
						?>
			...
			<div class="hester-tabs-content-wrap">
				<?php
				foreach ( $settings['tabs'] as $index => $item ) :
					$tab_count            = $index + 1;
					$active_item          = ( $tab_count === $settings['active_item'] ) ? ' hester-active' : '';
					...
					$this->add_render_attribute(
						$tab_content_key,
						array(
							'id'              => 'hester-tab-content-' . $tab_count,
							'class'           => array( 'hester-tab-content', $active_item ),
							'role'            => 'tabpanel',
							'aria-labelledby' => 'hester-tab-title-' . $id_int . $tab_count,
						)
					);
					...
					$this->add_render_attribute(
						...
						array(
							'class'    => array( 'hester-tab-title', 'hester-tab-mobile-title', $active_item ),
							'tabindex' => $id_int . $tab_count,
							'data-tab' => $tab_count,
							'role'     => 'tab',
						)
