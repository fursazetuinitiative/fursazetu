...
namespace Hester_Core\Elementor\Modules\ContactForm\Widgets;
...
class Contact_Form extends Base_Widget {
	...
	public function get_name() {
		return 'hester-contact-form-7';
	}

	public function get_title() {
		return __( 'Contact Form 7', 'hester-core' );
	}

	public function get_icon() {
		return 'hester-icon eicon-form-horizontal';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'form',
			array(
				'label'   => __( 'Select Form', 'hester-core' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Not Valid Notices', 'hester-core' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Inputs & Textarea', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Placeholder Color', 'hester-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Submit Button', 'hester-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'button_fullwidth',
			array(
				'label'        => __( 'Fullwidth Button', 'hester-core' ),
		...
		$this->add_control(
			'sent_heading',
			array(
				'label'     => __( 'Sent Success', 'hester-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'error_heading',
			array(
				'label'     => __( 'Sent Error', 'hester-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Not Valid', 'hester-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'spam_heading',
			array(
				'label'     => __( 'Spam Blocked', 'hester-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	protected function get_available_forms() {
		...
		if ( ! hester_is_contact_form_7_active() ) {
			return array();
		}
